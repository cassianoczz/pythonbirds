...
O Motor controla velocidade.
Possui os atributos:
1) Atributo de dado velocidade
2) Metodo acelerar, incrementar a velucidade de uma em uma unidade
3) Metodo frear, decrementa a velocidade de dois em dois até 0

A Direção controla a direcao.
Possui os atributos:
